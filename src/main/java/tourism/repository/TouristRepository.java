...
public class TouristRepository {
    ...
    public TouristRepository() {
        ...
        attractions.add(new TouristAttraction("BabyZoo på Gavnø Slot", "En lille zoologisk have, der fokuserer på babydyr.", "Gavnø", List.of(AttractionTag.FAMILIEVENLIG, AttractionTag.EVENTYRLIG)));
        attractions.add(new TouristAttraction("Råbjerg Mile", "En vandrende sandklit nær Skagen.", "Råbjerg Mile", List.of(AttractionTag.NATUR, AttractionTag.UDSIGT)));
        attractions.add(new TouristAttraction("Verdenskortet ved Klejtrup Sø", "En stor park med et stort kort over verden i skala 1:100.000.", "Klejtrup", List.of(AttractionTag.NATUR, AttractionTag.EVENTYRLIG)));
