...
public class TouristRepository {
    ...
    public TouristRepository() {
        ...
        attractions.add(new TouristAttraction("Cisternerne", "En tidligere vandreservoir under Frederiksberg Hill som nu er en kunst udstillingsplads.", "København", List.of(AttractionTag.EVENTYRLIG, AttractionTag.KUNST, AttractionTag.KULTUR)));
        attractions.add(new TouristAttraction("BabyZoo på Gavnoe Slot", "En lille zoologisk have, der fokuserer på babydyr.", "Sydsjælland", List.of(AttractionTag.FAMILIEVENLIG, AttractionTag.EVENTYRLIG)));
